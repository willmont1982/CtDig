...
export class LocalStorageUtils {
    private static clienteKey = 'ctdig.cliente';
    private static clienteToken = 'ctdig.cliente.token';

    private static agenciaKey = 'ctdig.agencia';
    private static agenciaToken = 'ctdig.agencia.token';
